...
static async_queue_t *async_queue_create(int size);
static BOOL async_cond_queue_push_tail(async_queue_t *q,task_t *t);
static task_t *async_cond_queue_pop_head(async_queue_t *q);
...
const async_cond_op_t async_cond_op = {
    "cond",
