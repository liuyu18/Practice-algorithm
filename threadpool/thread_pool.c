...
extern const async_eventfd_op_t async_eventfd_op;
extern const async_queue_op_t async_cond_op;

static const async_cond_op_t *async_queue_ops[] = {
    &async_cond_op,
    &async_eventfd_op
}

static threadpool_type_t thread_current = threadpool_cond_type;
...
threadpool_t *threadpool_create(int thread_count,int queue_size,int flags){
    ...
    if((pool = (thread_t *)malloc(sizeof(thread_t))) == NULL){
